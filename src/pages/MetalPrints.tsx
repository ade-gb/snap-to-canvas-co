...
const allProducts = [
  {
    id: "metal-family",
    name: "Family Portrait Metal Print",
    description: "Modern aluminum prints with vibrant colors and a sleek, frameless finish.",
    startingPrice: 15.99,
    originalPrice: 165,
    image: familyCanvas,
    category: "family",
  ...
  {
    id: "metal-pet",
    name: "Pet Portrait Metal Print",
    description: "Showcase your furry friend on luminous metal with stunning depth and clarity.",
    startingPrice: 15.99,
    originalPrice: 165,
    image: petCanvas,
    category: "pets",
  ...
  {
    id: "metal-travel",
    name: "Travel Memory Metal Print",
    description: "Ultra-modern metal prints that bring your travel photos to life with brilliant color.",
    startingPrice: 16.99,
    originalPrice: 169,
    image: sunsetCanvas,
    category: "travel",
  ...
  {
    id: "metal-wedding",
    name: "Wedding Metal Print",
    description: "Premium aluminum prints perfect for displaying your most precious moments.",
    startingPrice: 18.99,
    originalPrice: 179,
    image: weddingCanvas,
    category: "weddings",
  ...
  {
    id: "metal-landscape",
    name: "Landscape Metal Print",
    description: "Nature photography that pops off the wall with incredible vibrancy on metal.",
    startingPrice: 16.99,
    originalPrice: 169,
  ...
  {
    id: "metal-baby",
    name: "Baby Portrait Metal Print",
    description: "Contemporary metal prints that capture every precious detail of your newborn.",
    startingPrice: 15.99,
    originalPrice: 165,
    image: babyCanvas,
    category: "babies",
  ...
  {
    id: "metal-city",
    name: "City Skyline Metal Print",
    description: "Urban photography on sleek metal for a modern, gallery-quality look.",
    startingPrice: 21.95,
    originalPrice: 189,
    image: cityCanvas,
    category: "travel",
  ...
  {
    id: "metal-floral",
    name: "Floral Art Metal Print",
    description: "Botanical art with stunning color saturation and a contemporary metal finish.",
    startingPrice: 18.99,
    originalPrice: 179,
    image: floralCanvas,
    category: "nature",
